...
<div style="float:left; width:85px; padding:2px;" >
	...
	<a href="http://#request.app.url#/account/#reply.account.id()#/donate" class="donate" style="width:96%;text-align:center;font-size:1.4em;padding:5px 2px 5px 2px;">Donate</a>
</div>
